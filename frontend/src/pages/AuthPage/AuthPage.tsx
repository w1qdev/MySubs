...
export const AuthPage = () => {
    return (
        <div className="w-full flex flex-row">
            <motion.div className="w-3/10 h-screen bg-[#FFFFFF] flex justify-center items-center z-5">
                <motion.div
                ...
                >
                    <div className="w-full flex flex-row justify-between gap-1 rounded-md bg-[#F8FAFC] px-2 py-2 mb-6">
                        <button className="w-5/10 py-2 bg-white cursor-pointer rounded-md font-medium">
                            Вход
                        </button>
                        <button className="w-5/10 cursor-pointer text-[#343434] font-medium hover:bg-[#f1f1f1] px-2 py-2 rounded-md transition duration-300 ease-in-out">
                            Регистрация
                        </button>
                    </div>
